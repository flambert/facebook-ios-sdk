...
@synthesize FBRequestClass = _FBRequestClass; // mirego
...
- (FBRequest*)openUrl:(NSString *)url
    ...
    Class freqClass = _FBRequestClass;
    if (![freqClass isSubclassOfClass:[FBRequest class]])
        freqClass = [FBRequest class];
    ...
    FBRequest* _request = [freqClass getRequestWithParams:params
